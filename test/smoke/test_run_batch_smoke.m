...
elseif ~local_network_reachable(apiKey)
    ...
    try
        ...
        writecell({'account', 'openalex_institution_id', 'display_name', 'include', 'role'; ...
                   ...
                   'Fujita Health University', 'I9999999999', 'Excluded Candidate', '0', 'other'}, csvMulti);
        ...
        assert(Tsummary11.institution_name(1) == "Fujita Health University", ...
            'T11: institution_name mismatch');
        assert(Tsummary11.openalex_institution_id(1) == "I145673806|I4210124875", ...
        ...
        assert(isfield(meta11, 'filter') && contains(string(meta11.filter), ...
            "authorships.institutions.id:I145673806|I4210124875"), ...
        ...
        writecell({'account', 'openalex_institution_id', 'display_name', 'include', 'role'; ...
                   'Fujita Health University', 'I145673806', 'Fujita Health University', '1', 'main'; ...
                   'Fujita Health University', 'I4210124875', 'Fujita Health University Hospital', '1', 'hospital'}, csvLedger);
